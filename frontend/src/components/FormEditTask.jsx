...
const FormEditTask = () => {
  ...
  const updateTask = async (e) => {
    e.preventDefault();
    try {
      await axios.patch(`https://api.sipekan.my.id/tugas/${id}`, {
        title: title,
        ...
        <div className="col-md-8">
          <form onSubmit={updateTask}>
            ...
            <div className="mb-2">
              ...
              <input type="point" className="form-control" id="point" value={point} onChange={(e) => setPoint(e.target.value)} placeholder="0" />
            </div>
            <div className="mb-2">
